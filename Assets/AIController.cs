...
//        if (Vector3.Distance(transform.position, flag.transform.position) < /* Distance threshold */)
//        {
...
//        if (Vector3.Distance(transform.position, homeBase.transform.position) < /* Distance threshold */)
//        {
